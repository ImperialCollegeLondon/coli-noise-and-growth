function ref_pars = give_ref_pars ()
...
ref_params_data = readtable ( '../input-data/reference_params.csv') ;
...
ref_pars = compute_response ( ref_params_data{1,'avg_prot_number_at_birth'} , ref_pars , 'kp' , 'no' ) ;

% volume at birth
ref_pars.V_birth = give_V_birth_from_SJ (ref_pars.mu*60) ;
