...
% by default, no switches
modality_result.n_switches = 0 ;
modality_result.waitings_OFF = 0 ;
modality_result.waitings_ON = 0 ;
...
modality_result.waitings_OFF = waiting_times_OFF_ON .* dt ;
modality_result.waitings_ON = waiting_times_ON_OFF .* dt ;
